...
## Requirements - What You Need to Know to Make Most of This Book

Though the book offers many entry points to the reader and strives to make advanced considerations accessible knowledge of a scripting language and familiarity with a console / terminal will provide the reader with a kickstart and help avoid frustration. 

Programming with data contains its fair share of introductory examples but does not intend to be an introduction to R or Python, nor 
